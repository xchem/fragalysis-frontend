...
export const setLHSExtraColumns = lhs_extra_columns => {
  return {
    type: constants.SET_LHS_EXTRA_COLUMNS,
    lhs_extra_columns: lhs_extra_columns
  };
};

export const setRHSCompoundsList = rhs_compounds_list => {
  return {
    type: constants.SET_RHS_COMPOUNDS_LIST,
    rhs_compounds_list: rhs_compounds_list
  };
};
...
export const setTargetDataLoaded = targetDataLoaded => {
  return {
    type: constants.SET_TARGET_DATA_LOADED,
...
export const setRDKITScriptLoaded = rdkLoaded => {
  return {
    type: constants.SET_RDKIT_SCRIPT_LOADED,
    rdkLoaded: rdkLoaded
  };
};

export const setDataAreDownloading = dataAreDownloading => {
  return {
    type: constants.SET_DATA_ARE_DOWNLOADING,
