...
export const constants = {
  ...
  SET_OBSERVATIONS_DIALOG_SIDE: prefix + 'SET_OBSERVATIONS_DIALOG_SIDE',

  SET_IS_OBS_INSPIRATION_DIALOG_OPEN: prefix + 'SET_IS_OBS_INSPIRATION_DIALOG_OPEN',
  SET_OBS_INSPIRATION_DIALOG_OBS_IDS: prefix + 'SET_OBS_INSPIRATION_DIALOG_OBS_IDS',
  SET_OBS_INSPIRATION_DIALOG_POSE_ID: prefix + 'SET_OBS_INSPIRATION_DIALOG_POSE_ID',
  ...
  // Side-specific tag filtering state
  SET_LHS_TAG_FILTERING_MODE: prefix + 'SET_LHS_TAG_FILTERING_MODE',
  SET_RHS_TAG_FILTERING_MODE: prefix + 'SET_RHS_TAG_FILTERING_MODE',
  SET_LHS_DISPLAY_ALL_MOLECULES: prefix + 'SET_LHS_DISPLAY_ALL_MOLECULES',
  SET_RHS_DISPLAY_ALL_MOLECULES: prefix + 'SET_RHS_DISPLAY_ALL_MOLECULES',
  SET_LHS_DISPLAY_UNTAGGED_MOLECULES: prefix + 'SET_LHS_DISPLAY_UNTAGGED_MOLECULES',
  SET_RHS_DISPLAY_UNTAGGED_MOLECULES: prefix + 'SET_RHS_DISPLAY_UNTAGGED_MOLECULES',
  SET_LHS_TAG_DETAIL_VIEW: prefix + 'SET_LHS_TAG_DETAIL_VIEW',
  SET_RHS_TAG_DETAIL_VIEW: prefix + 'SET_RHS_TAG_DETAIL_VIEW',
  SET_LHS_SELECTED_TAGS: prefix + 'SET_LHS_SELECTED_TAGS',
  SET_RHS_SELECTED_TAGS: prefix + 'SET_RHS_SELECTED_TAGS',
  APPEND_LHS_SELECTED_TAG: prefix + 'APPEND_LHS_SELECTED_TAG',
  APPEND_RHS_SELECTED_TAG: prefix + 'APPEND_RHS_SELECTED_TAG',
  REMOVE_LHS_SELECTED_TAG: prefix + 'REMOVE_LHS_SELECTED_TAG',
  REMOVE_RHS_SELECTED_TAG: prefix + 'REMOVE_RHS_SELECTED_TAG',
  ...
  SET_RHS_POSE_NAVIGATION_CONFIG: prefix + 'SET_RHS_POSE_NAVIGATION_CONFIG',

  SET_LHS_IS_FULLY_RENDERED: prefix + 'SET_LHS_IS_FULLY_RENDERED',
  SET_RHS_IS_FULLY_RENDERED: prefix + 'SET_RHS_IS_FULLY_RENDERED',

  SET_RHS_COMPOUNDS_INITIALIZED: prefix + 'SET_RHS_COMPOUNDS_INITIALIZED',

  SET_UNIFIED_FILTER_ITEM: prefix + 'SET_UNIFIED_FILTER_ITEM',

  SET_ACTIVE_COORDINATE_FILTER_SIDE: prefix + 'SET_ACTIVE_COORDINATE_FILTER_SIDE',
  ...
  SET_PROTEIN_SETTINGS: prefix + 'SET_PROTEIN_SETTINGS',
  APPEND_PROTEIN_SETTINGS: prefix + 'APPEND_PROTEIN_SETTINGS',
  REMOVE_FROM_PROTEIN_SETTINGS: prefix + 'REMOVE_FROM_PROTEIN_SETTINGS'
};
