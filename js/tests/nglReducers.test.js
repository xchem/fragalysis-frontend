...
describe('NGL reducer', () => {
  it('should return the initial state', () => {
    expect(nglReducers(undefined, {})).toEqual(getInitialState());
  });
  it('should handle LOAD_OBJECT', () => {
    ...
    ).toEqual(TEST_LOAD_ONE_STATE);
  });
  it('should handle LOAD_OBJECT_SUCCESS', () => {
    expect(
      nglReducers(TEST_LOADING_ONE_STATE, {
        type: types.LOAD_OBJECT_SUCCESS,
        group: TEST_OBJ_ONE
      })
    ).toEqual(TEST_LOADED_ONE_STATE);
  });
  it('should handle LOAD_OBJECT_FAILURE', () => {
    expect(
      nglReducers(TEST_LOAD_ONE_STATE, {
  ...
  it('should handle DELETE_OBJECT', () => {
    expect(
      nglReducers(TEST_LOADED_ONE_STATE, {
        type: types.DELETE_OBJECT,
        group: TEST_OBJ_ONE
      })
    ).toEqual(TEST_DEL_ONE_STATE);
  });
  it('should handle DELETE_OBJECT_SUCCESS', () => {
    expect(
      nglReducers(TEST_DEL_ONE_STATE, {
