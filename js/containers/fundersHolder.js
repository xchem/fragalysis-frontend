...
class FundersHolder extends Component {
  ...
  openJff() {
    window.location.href =
      "https://researchsupport.admin.ox.ac.uk/funding/internal/jff";
  }
  openNf() {
  ...
  render() {
    ...
    return (
      <div>
        <Grid fluid>
          <Row style={{ height: padHeight }}></Row>
          ...
          <Row style={{ height: rowHeight }}>
            ...
            <Col xs={4} md={4}>
              <div className="text-center">
                <img
                  src={require("../img/mrcLogo.png")}
                  width={logoWidth}
                  onClick={this.openMrc}
                />
              </div>
            </Col>
            <Col xs={4} md={4}>
          ...
          <Row style={{ height: rowHeight }}>
            ...
            <Col xs={4} md={4}>
              <div className="text-center">
                <img
                  src={require("../img/jffLogo.jpg")}
                  width={logoWidth}
                  onClick={this.openJff}
                />
              </div>
            </Col>
            <Col xs={4} md={4}>
