...
export class DockingScripts {
  ...
  getDockingScript(constraint_smiles) {
    return (
      '/usr/bin/obabel -imol /data/reference.sdf -h -O /data/reference_hydrogens.sdf\n' +
      ...
      '/rDock_2013.1_src/bin/sdtether /data/reference_hydrogens.sdf  /data/input_hydrogens.sdf /data/output.sdf "' +
      constraint_smiles +
      '"\n' +
