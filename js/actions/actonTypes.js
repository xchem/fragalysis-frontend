...
// State broadcast
export const TOGGLE_ORIENTATION_FLAG = 'TOGGLE_ORIENTATION_FLAG';
export const GET_NGL_ORIENTATION = 'GET_NGL_ORIENTATION';
export const REQUEST_TO_SET_ORIENTATION = 'REQUEST_TO_SET_ORIENTATION';
export const SET_NGL_ORIENTATION = 'SET_NGL_ORIENTATION';
export const CONFIRM_ORIENTATION_COLLECTION = 'CONFIRM_ORIENTATION_COLLECTION';
