...
import { getAllVisibleButNotLockedCompounds, lockCompounds } from './redux/dispatchActions';
...
export const LockVisibleCompoundsDialog = forwardRef(({ open = false, anchorEl, datasetId, currentCmp }, ref) => {
    ...
    <Popper id={id} open={open} anchorEl={anchorEl} placement="left-start" ref={ref}>
      ...
      >
        <Grid container direction="column">
          <Grid item>
            <Typography>Do you want to lock visible compounds? Otherwise they will disapear from the view.</Typography>
          </Grid>
