...
class SummaryView extends React.Component {
  ...
  async handleDocking() {
    ...
    var url =
      ...
      '/api/protpdb/' +
      this.props.to_query_prot.toString() +
      '/';
  ...
  render() {
    var interaction_select =
      this.state.interaction_select == undefined ? 'Not selected' : this.state.interaction_select;
      ...
      <div>
        <Well>
          <Row>
            <Col xs={6} md={6}>
              <h5>
                Number picked: <b>{this.state.list_len}</b>
              </h5>
              <h5>
                Number vectors explored: <b>{this.state.num_vectors}</b>
              </h5>
              <h5>
                Number series explored: <b>{this.state.num_series}</b>
              </h5>
              <h5>
                Estimated cost: <b>£{this.state.cost}</b>
              </h5>
              <ButtonToolbar>
                <Button bsSize="sm" bsStyle="success" onClick={this.handleExport}>
                  Download CSV (Chrome)
                </Button>
                <Button bsSize="sm" bsStyle="success" onClick={this.handleYankDuck}>
                  Download Yank/Duck
                </Button>
              </ButtonToolbar>
              <h5>
                Selected Interaction: <b>{interaction_select}</b>
              </h5>
            </Col>
            <Col xs={6} md={6}>
