...
class MoleculeView extends GenericView {
    ...
    render() {
        ...
        const selected_style = {height: this.props.width.toString()+'px', backgroundColor: this.colourToggle}
        const not_selected_style = {height: this.props.width.toString()+'px'}
