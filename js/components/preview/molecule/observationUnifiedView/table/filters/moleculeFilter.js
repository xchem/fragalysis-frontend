...
import { Checkbox, FormControl, FormControlLabel, Grid, IconButton, makeStyles, Radio, RadioGroup, TextField, Tooltip } from "@material-ui/core"
...
export const MoleculeFilter = memo(({ onFilterChange }) => {
    ...
    >
        ...
        <Grid container direction="column">
            ...
            <Grid item xs><FormControlLabel control={<Checkbox checked={filterValue.smarts} onChange={e => handleFilterChange('smarts', e.target.checked)} />} label="SMARTs query" /></Grid>
            <Grid item xs><FormControlLabel control={<Checkbox checked={filterValue.distinct} onChange={e => handleFilterChange('distinct', e.target.checked)} />} label="Treat stereoisomers as distinct" /></Grid>
            {/* <Grid item xs><Editor
            ...
            <Grid item xs>
                ...
                <Jsme height={320} width={370} smiles={editorSmiles} options={options} onChange={smiles => handleSmilesChange(smiles)} />
            ...
            <Grid item xs>
                ...
                <FormControlLabel control={<TextField className={classes.smilesInput} value={inputSmiles} onChange={e => handleSmilesChange(e.target.value)} />} label="SMILES/SMARTs query" labelPlacement="start" />
                ...
                <Tooltip title="Update editor from SMILES/SMARTs query">
                    <IconButton
                        color="primary"
                        onClick={handleApplyInputSmiles}
                    >
