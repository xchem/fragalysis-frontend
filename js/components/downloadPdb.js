...
class DownloadPdb extends React.Component {
    ...
    async handlePdbDownload() {
        var protPdbUrl = window.location.protocol + "//" + window.location.host + "/api/protpdb/?limit=2000&?target_id=" + this.props.targetOn.toString();
        var proteinsUrl = window.location.protocol + "//" + window.location.host + "/api/proteins/?limit=2000&?target_id=" + this.props.targetOn.toString();
