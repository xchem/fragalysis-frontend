...
export class NGLView extends React.Component {
  constructor(props) {
    ...
    this.data_dict = {};
    this.data_dict[listTypes.MOLGROUPS] = {
      oldGroupOn: -1,
      oldGroupsOn: [],
      list: 'mol_group_list',
    ...
    this.data_dict[listTypes.PANDDA_SITE] = {
      oldGroupOn: -1,
      oldGroupsOn: [],
  ...
  componentDidMount() {
    ...
    this.props.setOrientation(this.div_id, 'STARTED');
    ...
    if (this.props.nglOrientations != undefined) {
      if (this.props.nglOrientations[this.div_id] == 'REFRESH') {
        if (this.checkIfLoading() == true) {
          ...
          this.props.setOrientation(this.div_id, {
