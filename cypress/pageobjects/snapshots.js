...
class snapshots{
    elements = { 
        ...
        createSnapshotButton : () => cy.get('#new-snapshot-button-id'), // MISSING ID!!!!
        renameSnapshotButton : () => cy.get('button.MuiButton-containedPrimary'),
        updateSnapshotButton : () => cy.get(':nth-child(1) > .MuiPaper-root > .jss224 > :nth-child(3) > .MuiButtonBase-root > .MuiButton-label'), 
        ...
        shareSnapshotButton : () => cy.get(':nth-child(1) > .MuiPaper-root > .jss224 > :nth-child(2) > .MuiButtonBase-root > .MuiButton-label')
